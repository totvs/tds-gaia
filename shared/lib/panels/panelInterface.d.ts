 ...
 */
export type TErrorType = "required" | "min" | "max" | "minLength" | "maxLength" | "pattern" | "validate" | "warning";
/**
 ...
 */
export declare function isErrors<M>(errors: TFieldErrors<M>): boolean;
/**
...
//# sourceMappingURL=panelInterface.d.ts.map